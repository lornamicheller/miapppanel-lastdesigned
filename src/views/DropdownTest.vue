<template>
  ...
  <!-- Wrapper -->
  <main class="main">
    <p class="main__subtitle">Press the navigation button in the right corner to see the animation.</p>
    <div class="main__social">
      <a href="https://twitter.com/berikidis" class="main__link" target="_blank" rel="noopener">
      ...
      <a href="https://github.com/xxxx0011" class="main__link" target="_blank" rel="noopener">
      ...
      <a href="https://linkedin.com/in/berikidis" class="main__link" target="_blank" rel="noopener">
        <svg class="main__svg" viewBox="0 0 496 512">
